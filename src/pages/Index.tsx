      ...
      <div className="site-container">
        <div className="surface-panel relative isolate overflow-hidden">
          <img
            ...
            loading="eager"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0f1720]/72 via-[#0f1720]/44 to-[#0f1720]/24" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0f1720]/52 via-transparent to-[#0f1720]/16" />

          <div className="relative z-10 max-w-2xl space-y-5 px-6 py-14 sm:px-10 sm:py-18 lg:px-12 lg:py-20">
